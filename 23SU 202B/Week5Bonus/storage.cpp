...
//
//        while (!q1.empty()) {
//            int a1 = std::get<0>(q1.front());
//            int b1 = std::get<1>(q1.front());
//            int c1 = std::get<2>(q1.front());
//            q1.pop();
...
//                        break;
//                } else {
//                    visited[aa][bb][cc] = visited[a1][b1][c1]+1;
//                    std::tuple<int,int,int> temp = std::make_tuple(aa,bb,cc);
//                    q1.push(temp);
//                    visited[aa][bb][cc] = true;
//
//                }
...
//    }
//
//    std::cout << maze[a-1][b-1][c-1] << std::endl;
//}
//
//
